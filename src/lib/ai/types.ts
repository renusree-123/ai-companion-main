 ...
 *
 * Application code never imports a provider SDK directly — it depends on
...
export type AiFeature =
  ...
  | "EVALUATION"
  | "CLASSIFICATION"
  // AI Learning Hub — topic-first tools that sit outside a Project. Kept as
  // distinct features so Hub spend and latency never get confused with the
  // grounded, project-scoped experiences in the admin AI dashboard.
  | "HUB_QUIZ"
  | "HUB_SUMMARY"
  | "HUB_EXPLAIN";
